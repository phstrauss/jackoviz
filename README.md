...
- Then, push the "Setup" button, select "Parameters", "Sample Rate" 44100 Hz or 48000 Hz, "Frames/Period" 128, and check the "Realtime" checkbox.
...
Note that it is unclear to me if the [LunarG Vulkan SDK](https://vulkan.lunarg.com/sdk/home) is a dependency to this project or not (as an older version may well be shipped by macOS), in case of failure to start the plot window, install it in its standard location.
